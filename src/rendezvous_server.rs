...
pub struct RendezvousServer {
    ...
    inner: Arc<Inner>,
    // Added: record full STUN NAT type
    stun_nat_types: Arc<Mutex<HashMap<String, StunNatType>>>,
}
...
impl RendezvousServer {
    ...
    pub async fn start(port: i32, serial: i32, key: &str, rmem: usize) -> ResultType<()> {
        ...
        let mut rs = Self {
            ...
            stun_nat_types: Arc::new(Mutex::new(HashMap::new())),
        };
